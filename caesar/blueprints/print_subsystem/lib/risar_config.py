...
risar_gymnastics = 'gymnastics'
risar_psychological_preparation = 'psychological_preparation'
risar_maternity_lessons = 'maternity_lessons'
...
class PregnancyResult(object):
    abortion = ('therapeutic_abortion', 'therapeutic_abortion_before_12')
    birth = ('delivery', 'postmature_birth', 'premature_birth_22-27', 'premature_birth_28-37')
    early_birth = ('premature_birth_22-27', 'premature_birth_28-37')
