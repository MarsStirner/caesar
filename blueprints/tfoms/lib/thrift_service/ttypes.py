...
class Usl:
  ...
  thrift_spec = (
    ...
    (5, TType.I32, 'contract_TariffId', None, 0, ), # 5
  )

  def __init__(self, IDSERV=thrift_spec[1][4], CODE_USL=thrift_spec[2][4], KOL_USL=thrift_spec[3][4], TARIF=thrift_spec[4][4], contract_TariffId=thrift_spec[5][4],):
    ...
    self.TARIF = TARIF
    if contract_TariffId is self.thrift_spec[5][4]:
      contract_TariffId = 0
...
class Sluch:
  ...
  def __init__(self, IDCASE=thrift_spec[1][4], USL_OK=thrift_spec[2][4], VIDPOM=thrift_spec[3][4], NPR_MO=None, EXTR=None, LPU=thrift_spec[6][4], LPU_1=None, PODR=None, PROFIL=thrift_spec[9][4], DET=None, NHISTORY=thrift_spec[11][4], DATE_1=thrift_spec[12][4], DATE_2=thrift_spec[13][4], DS0=None, DS1=thrift_spec[15][4], DS2=None, CODE_MES1=None, CODE_MES2=None, RSLT=thrift_spec[19][4], ISHOD=thrift_spec[20][4], PRVS=thrift_spec[21][4], IDDOKT=thrift_spec[22][4], IDSP=thrift_spec[23][4], ED_COL=thrift_spec[24][4], SUMV=thrift_spec[25][4], OPLATA=None, USL=None, OS_SLUCH=None, actionId=thrift_spec[30][4], eventId=thrift_spec[31][4], rbServiceId=thrift_spec[32][4],):
    ...
    if actionId is self.thrift_spec[30][4]:
      actionId = 0
    self.actionId = actionId
    if eventId is self.thrift_spec[31][4]:
      eventId = 0
    self.eventId = eventId
    if rbServiceId is self.thrift_spec[32][4]:
      rbServiceId = 0
  ...
  def write(self, oprot):
    ...
    if self.OS_SLUCH is not None:
      oprot.writeFieldBegin('OS_SLUCH', TType.LIST, 28)
...
class TClientPolicy:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.insurerInfisCode = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.insurerInfisCode is not None:
      ...
      oprot.writeString(self.insurerInfisCode)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.SER_POL = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.STRING:
          self.NOM_POL = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.STRING:
          self.FAMIL = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.STRING:
          self.IMYA = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.STRING:
        ...
        if ftype == TType.STRING:
          self.KOD_F = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.STRING:
          self.POL = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.I64:
        ...
        if ftype == TType.STRING:
          self.NAS_P = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 14:
        if ftype == TType.STRING:
          self.UL = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 15:
        if ftype == TType.STRING:
        ...
        if ftype == TType.STRING:
          self.MES_R = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 19:
        if ftype == TType.STRING:
          self.KOD_PR = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 20:
        if ftype == TType.I16:
        ...
        if ftype == TType.STRING:
          self.N_KART = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 22:
        if ftype == TType.STRING:
          self.DIA_O = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 23:
        if ftype == TType.STRING:
          self.DOP_D = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 24:
        if ftype == TType.STRING:
          self.DIA_S = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 25:
        if ftype == TType.STRING:
          self.DOP_S = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 26:
        if ftype == TType.STRING:
          self.DIA_S1 = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 27:
        if ftype == TType.STRING:
          self.DOP_S1 = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 28:
        if ftype == TType.STRING:
          self.OSL = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 29:
        if ftype == TType.STRING:
          self.DOP_OSL = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 30:
        if ftype == TType.STRING:
          self.KSG_MS = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 31:
        if ftype == TType.I16:
        ...
        if ftype == TType.STRING:
          self.KOD_VR = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 37:
        if ftype == TType.STRING:
          self.KOD_O = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 38:
        if ftype == TType.STRING:
          self.N_OPER = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 39:
        if ftype == TType.I32:
        ...
        if ftype == TType.STRING:
          self.SER_DOK = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 45:
        if ftype == TType.STRING:
          self.NOM_DOK = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 46:
        if ftype == TType.I16:
